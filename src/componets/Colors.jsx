            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex justify-center mb-12">
                    <div className="relative w-full max-w-3xl">
                        <div className="relative flex items-center justify-center mind-h-[500px]">
                            <img src={colors.find( color => color.id === selectedColor).image}
                                alt="iphone 17"
                                className="max-w-full max-h-[600] mx-auto"
                            ></img>
                        </div>
                ...
                <div className="flex justify-center items-center gap-4">
                    ...
                    <div className="grid gap-8 mt-20 grid-cols-2">
                        ...
                        <div key={index} className="bg-gradient-to-br from-gray-900 to-transparent rounded-3xl p-8 border border-gray-800">
                            ...
                            <ul className="space-y2 text-gray-300">
                                <li>{model.storage}</li>
                                <li>{model.battery}</li>
                                <li>{model.weight}</li>
                            </ul>
                        ...
                        <div className="text-center mt-16">
                            <button className="bg-blue-800 text-white px-12 py-4 rounded-full text-lg font-medium transition-all duration-300 mb-8 hover:scale-105 shadow-md shadow-blues-500/50 cursor-pointer">
                                Compre agora a partir de R$11.939,04
                            </button>
